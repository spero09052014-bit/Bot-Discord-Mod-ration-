...
class Warn(commands.Cog):
    ...
    @commands.command(name="warn", help="Ajoute un avertissement à un membre.")
    ...
    @commands.command(name="warnings", aliases=["warnlist"], help="Liste les avertissements d'un membre.")
    @commands.has_permissions(manage_messages=True)
    @commands.guild_only()
    ...
    @commands.command(name="unwarn", help="Retire un avertissement précis d'un membre (voir !warnings pour l'index).")
    @commands.has_permissions(manage_messages=True)
    @commands.guild_only()

...
Accès : uniquement les IDs listés dans FOUNDER_IDS (.env)
================================================================
"""
...
# On récupère la liste des IDs des fondateurs directement depuis le .env.
# Format attendu : FOUNDER_IDS=123456789012345678,987654321098765432
# => Pour ajouter/retirer un fondateur, il suffit de modifier le .env,
#    AUCUN code à toucher !
FOUNDER_IDS_RAW = os.getenv("FOUNDER_IDS", "")
FOUNDER_IDS = {
    int(id_str.strip())
    for id_str in FOUNDER_IDS_RAW.split(",")
...
def est_fondateur():
    ...
    uniquement si l'auteur du message fait partie des FOUNDER_IDS.
    """
    async def predicate(ctx: commands.Context) -> bool:
        return ctx.author.id in FOUNDER_IDS
